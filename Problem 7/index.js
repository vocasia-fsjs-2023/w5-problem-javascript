// Soal 1
/* Buatlah sebuah loop untuk mengecek setiap 3 angka dari 1-100, lalu cetak angka tersebut dan menuliskan 
apakah bilangan tersebut ganjil atau genap */
console.log("1. Mengecek Bilangan Ganjil atau Genap dari 1-100");
console.log("--------");
for (let i = 1; i <= 100; i++) {
  if (i % 2 === 0) {
    console.log(i + " - genap");
...
// Soal 2
/* Buatlah sebuah loop untuk mengecek setiap 5 angka dari 50-200, lalu cetak angka tersebut dan tuliskan 
apakah bilangan tersebut merupakan faktor perkalian 3 atau bukan. */
console.log("Mengecek Bilangan Faktor 3 dari 50-200");
console.log("--------");
